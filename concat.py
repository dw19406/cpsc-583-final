...
### Load method ###
model = NodeFormer(d, args.hidden_channels, 128, num_layers=args.num_layers, num_heads=args.num_heads, nb_random_features=args.M, 
...
model2=GAT2(128, args.hidden_channels, c, num_layers=2, use_bn=args.use_bn, heads=args.gat_heads, out_heads=args.out_heads).to(device)
